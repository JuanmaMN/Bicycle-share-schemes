...
gboth_Hour2<- ggplot("data_source", aes(x=hour, y=total, fill = usertype)) +
  geom_bar(stat="identity",  width=0.4, position=position_dodge(width = 0.5)) +
  scale_y_continuous(breaks = seq(0, 1500000,by =500000),limits=c(0, 1750000), labels = c(" ","500,000","1,000,000","1,500,000"),
                     expand = c(.007, .007))+
  scale_fill_manual(values = c("#8fb9c9", "#c0d8c5")) +
  theme_ipsum_rc() +
  labs(y = "",
       title = "NYC's Official Bike Sharing System - Number of trips by hour of the day",
  ...
  geom_segment(aes(x=0.5,xend=24.3,y=0,yend=0),linetype="dotted",colour = "#525252") +
  geom_segment(aes(x=0.5,xend=24.3,y=500000,yend=500000),linetype="dotted",colour = "#525252")+
  geom_segment(aes(x=0.5,xend=24.3,y=1000000,yend=1000000),linetype="dotted",colour = "#525252") +
  geom_segment(aes(x=0.5,xend=24.3,y=1500000,yend=1500000),linetype="dotted",colour = "#525252") +
  geom_segment(aes(x=0.5,xend=24.3,y=2000000,yend=2000000),linetype="dotted",colour = "#525252")  +
  annotate("text", family = font_labels, y = 1550000, x = 20.2,  hjust = 0, size = 3.5, color = "#808080",
           label = "Customer = 24-hour pass or 3-day pass user")  +
  annotate("text", family = font_labels, y = 1600000, x = 20.2,  hjust = 0, size = 3.5, color = "#808080",
           label = "Subscriber = Annual Member")  +
  annotate("text", family = font_labels, y = 1600000, x = 20.1,  hjust = 0, size = 3.5, color = "#808080",
           label = "*") 
