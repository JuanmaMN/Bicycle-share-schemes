...
pacman::p_load(readr,readxl, lubridate, tidyverse, ggplot2, ggtext, hrbrthemes, gridExtra,patchwork, systemfonts, sysfonts,showtext, ggpubr,
...
PNYC_combined <- graph_hour_Day + plot_annotation(title = "NYC's Official Bike Sharing System",
