...
gboth_Hour_Boston<- ggplot(data_source, aes(x=Hour, y=total, fill = usertype))  +
  geom_bar(stat="identity",  width=0.4, position=position_dodge(width = 0.5)) +
  scale_y_continuous(breaks = seq(0, 160000,by = 50000),limits=c(0, 160000), labels = c(" ","50,000","100,000","150,000"),
                     expand = c(.007, .007))+
  ...
  geom_segment(aes(x=0.5,xend=24.3,y=50000,yend=50000),linetype="dotted",colour = "#525252")+
  geom_segment(aes(x=0.5,xend=24.3,y=100000,yend=100000),linetype="dotted",colour = "#525252") +
  geom_segment(aes(x=0.5,xend=24.3,y=150000,yend=150000),linetype="dotted",colour = "#525252") +
  annotate("text", family = font_labels, y = 155000, x = 20.5,  hjust = 0, size = 3.5, color = "#808080",
           label = "Customer = Single Trip or Day Pass user")  +
  annotate("text", family = font_labels, y = 160000, x = 20.5,  hjust = 0, size = 3.5, color = "#808080",
           label = "Subscriber = Annual or Monthly Member")  +
  annotate("text", family = font_labels, y = 160000, x = 20.4,  hjust = 0, size = 3.5, color = "#808080",
           label = "*") 
